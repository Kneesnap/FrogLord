...
public enum kcActionID {
    ...
    NUMBER((byte) 0x37, "BroadcastNumberCause", kcEntityInheritanceGroup.ENTITY, false, kcActionNumber::new), // kcCEntity::OnCommand
    ...
    WITH_ITEM((byte) 0x3B, "BroadcastIfPlayerHasItem", kcEntityInheritanceGroup.PROP_OR_CHARACTER, false, kcActionLazyTemplate.WITH_ITEM_ARGUMENTS), // CCharacter::OnCommand, CProp::OnCommand
