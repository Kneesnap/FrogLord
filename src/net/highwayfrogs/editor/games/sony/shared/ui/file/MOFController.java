 ...
 * Unfortunately this is a supreme mess atm. I'm not sure if it's worth cleaning up though. There won't be a lot of major additions to MOF, except maybe FMD, which isn't UI-related.
 * Created by Kneesnap on 2/13/2019.
 */
@Getter
public class MOFController extends SCFileEditorUIController<SCGameInstance, MOFHolder> {
    ...
    public void setupMofViewer(Stage stageToOverride) {
        ...
        uiPane.setLeft(this.uiController.getRootNode());
    ...
    /**
     * Initialise the editor to edit an animation.
    ...
    @Getter
    public static final class MOFUIController extends GameUIController<SCGameInstance> {
