 ...
 */
@Getter
public class GridController extends GameUIController<FroggerGameInstance> {
    ...
    private GridController(GeometryManager manager) {
        super(manager.getMap().getGameInstance());
    ...
    public static void openGridEditor(GeometryManager manager) {
        Utils.createWindowFromFXMLTemplate("window-edit-map-collision-grid", new GridController(manager), "Grid Editor", true);
    }
}