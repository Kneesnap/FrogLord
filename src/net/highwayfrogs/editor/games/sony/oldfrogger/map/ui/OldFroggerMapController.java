 ...
 */
public class OldFroggerMapController extends EditorController<OldFroggerMapFile, OldFroggerGameInstance, SCGameConfig> {
    ...
    @Override
    public void loadFile(OldFroggerMapFile map) {
        super.loadFile(map);
    ...
    private void onView(ActionEvent evt) {
        MeshViewController.setupMeshViewer(GUIMain.MAIN_STAGE, new OldFroggerMapMeshController(), new OldFroggerMapMesh(getFile()));
    }
}