...
import net.highwayfrogs.editor.games.greatquest.audio.IDXFile;
import net.highwayfrogs.editor.games.greatquest.audio.IDXFile.kcStreamIndexEntry;
import net.highwayfrogs.editor.games.greatquest.audio.SBRFile;
import net.highwayfrogs.editor.games.greatquest.audio.SBRFile.SfxEntry;
import net.highwayfrogs.editor.games.greatquest.audio.SBRFile.SfxEntrySimpleAttributes;
import net.highwayfrogs.editor.games.greatquest.audio.SBRFile.SfxWave;
