...
import net.highwayfrogs.editor.games.tgq.entity.*;
import net.highwayfrogs.editor.games.tgq.kcClassID;
import net.highwayfrogs.editor.games.tgq.model.kcModelDesc;
import net.highwayfrogs.editor.games.tgq.proxy.kcEmitterDesc;
import net.highwayfrogs.editor.games.tgq.proxy.kcProxyCapsuleDesc;
import net.highwayfrogs.editor.games.tgq.proxy.kcProxyTriMeshDesc;
