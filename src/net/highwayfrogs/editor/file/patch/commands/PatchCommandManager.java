...
public class PatchCommandManager {
    ...
    private static void setupCommands() {
        ...
        addCommand(new PatchCommandWrite("writecolor", (writer, value) -> writer.writeInt(ColorUtils.toRGB(value.getAsColor()))));
        ...
        addCommand(new PatchCommandRead("readcolor", (reader, value) -> value.setColor(ColorUtils.fromRGB(reader.readInt()))));
