...
public enum FormBook {
    ...
    FOR_BREAKINGBRANCH(MAPTheme.FOREST, 11, EntityBook.SQUIRREL, FLAG_DONT_RESET_ON_CHECKPOINT | FLAG_DONT_RESET_ON_DEATH, null),
    ...
    FOR_RIVER_NOISE(MAPTheme.FOREST, 14, EntityBook.STATIC, FLAG_NO_MODEL, null),
    ...
    JUN_BUTTERFLY(MAPTheme.JUNGLE, 8, EntityBook.MOVING_TONGUEABLE, null),
    ...
    JUN_WATER_NOISE(MAPTheme.JUNGLE, CODE_NULL_OFFSET, EntityBook.STATIC, FLAG_NO_MODEL, null),
