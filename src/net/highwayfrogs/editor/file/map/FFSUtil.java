...
public class FFSUtil {
    ...
    public static void saveMapAsFFS(MAPFile map, File outputDir) throws IOException {
        ...
        @Cleanup PrintWriter pw = new PrintWriter(new File(outputDir, Utils.stripExtension(map.getIndexEntry().getDisplayName()) + ".ffs"));
        ...
        pw.close();
        System.out.println("Exported " + map.getIndexEntry().getDisplayName() + " to " + outputDir.getName() + File.separator + ".");
    }
    ...
    public static void importFFSToMap(MAPFile map, File inputFile) throws IOException {
        ...
        System.out.println("Imported " + inputFile.getName() + " as " + map.getIndexEntry().getDisplayName() + ".");
    }
}