...
public enum GridSquareFlag {
    CAN_HOP(Constants.BIT_FLAG_0), // Frog can jump here.
    COLLISION(Constants.BIT_FLAG_1), // Standard land.
    ...
    SLIPPY_CONTROLS(Constants.BIT_FLAG_7), // Slippy but frogger can control.
    SOFT_GROUND(Constants.BIT_FLAG_8), // Frog won't die from fall damage.
    EXTENDED_HOP_HEIGHT(Constants.BIT_FLAG_9), // Unused. Believe this was supposed to extend the height the frog can super jump at. But, it's not used.
