...
/**
 * Implementation of the '#ifndef' preprocessor directive.
 */
public class NoodlePreprocessorDirectiveIfNotDef extends NoodlePreprocessorConditionDirective {
    private String symbolName;

    protected NoodlePreprocessorDirectiveIfNotDef(NoodleCodeLocation location) {
        super(NoodlePreprocessorDirectiveType.IFNDEF, location);
    }
