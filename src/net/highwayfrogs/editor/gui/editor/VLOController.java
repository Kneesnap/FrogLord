...
public class VLOController extends EditorController<VLOArchive> {
    ...
    public void updateImageInfo() {
        ...
        idLabel.setText("ABR: " + this.selectedImage.getAbr() + " Mode: " + this.selectedImage.getClutMode().getDisplayName() + " VRAM: [" + this.selectedImage.getVramX() + ", " + this.selectedImage.getVramY() + "]");
    }
