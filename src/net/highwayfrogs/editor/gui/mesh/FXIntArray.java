 ...
 * ObservableIntegerArray documentation says that optimal performance is obtained with the fewest number of method calls possible, so this also yields better performance.
