...
/**
 * A translation gizmo represents a 3D UI element which can be expanded in any of the XYZ directions, indicating scale.
...
public class ScaleGizmo extends DynamicMesh {
    ...
    private void setupMesh() {
        ...
        if (this.xAxisEnabled) {
            ...
            MeshUtils.createCenteredBoxWithDimensions(xNodeEntry, AXIS_BASE_BOX_DISTANCE, 0, 0, BOX_SIZE, BOX_SIZE, BOX_SIZE, this.redTextureUvIndex);
        ...
        if (this.zAxisEnabled) {
            ...
            MeshUtils.createCenteredBoxWithDimensions(zNodeEntry, 0, 0, AXIS_BASE_BOX_DISTANCE, BOX_SIZE, BOX_SIZE, BOX_SIZE, this.blueTextureUvIndex);
        ...
        if (this.yAxisEnabled) {
            ...
            MeshUtils.createCenteredBoxWithDimensions(yNodeEntry, 0, -AXIS_BASE_BOX_DISTANCE, 0, BOX_SIZE, BOX_SIZE, BOX_SIZE, this.greenTextureUvIndex);
    ...
    private void onDragUpdate(MouseEvent event) {
        ...
        if (this.movementAxis == Rotate.X_AXIS) {
            ...
            if (state.getChangeListener() != null)
                state.getChangeListener().handle(oldX, oldY, oldZ, newX, oldY, oldZ);
        } else if (this.movementAxis == Rotate.Y_AXIS) {
            ...
            if (state.getChangeListener() != null)
                state.getChangeListener().handle(oldX, oldY, oldZ, oldX, newY, oldZ);
        } else if (this.movementAxis == Rotate.Z_AXIS) {
            ...
            if (state.getChangeListener() != null)
                state.getChangeListener().handle(oldX, oldY, oldZ, oldX, oldY, newZ);
        }
    }
